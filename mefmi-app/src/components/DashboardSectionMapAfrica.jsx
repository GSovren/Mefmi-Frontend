...
import "../components/DashboardSectionMapAfrica";
  ...
  return (
    <div className="world-map">
      <svg
        ...
        version="1.1"
      >
        {/* Metadata and Inkscape views omitted for brevity, keep them if needed */}
        ...
        <a href="" target="" rel="noopener noreferrer" aria-label="Uganda">
          <path
            className="Uganda"
        ...
        <circle
          cx={600} // approximate x coordinate, adjust as needed
          cy={750} // approximate y coordinate, adjust as needed
          r={2}
          fill="red"
          stroke="white"
          strokeWidth={0.5}
        ...
        {/* Label for Uganda */}
        <text
          x={600} // offset x for label
          y={750} // offset y for label
          style={{ fontSize: "9px", fontWeight: 'bold', cursor: "pointer" }}
        ...
        <a href="" target="" rel="noopener noreferrer" aria-label="Zambia">
          <path
            className="Zambia"
        ...
        <circle
          cx={600} // approximate x coordinate
          cy={700} // approximate y coordinate
          r={5}
          fill="red"
          stroke="white"
          strokeWidth={1}
        ...
        {/* Label for Zambia */}
        <text
          x={610} // offset x for label
          y={720} // offset y for label
        ...
        <a href="" target="" rel="noopener noreferrer" aria-label="Zimbabwe">
          <path
            className="Zimbabwe"
        ...
        <circle
          cx={645} // x position, adjust as needed
          cy={785} // y position, adjust as needed
